...
item replace entity @s armor.legs with minecraft:leather_leggings{Unbreakable:1,display:{color:13590276},HideFlags:68} 1
item replace entity @s armor.feet with minecraft:leather_boots{Unbreakable:1,display:{color:13590276},Enchantments:[{id:"feather_falling",lvl:1}],HideFlags:69} 1
