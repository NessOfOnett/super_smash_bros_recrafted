item replace entity @s armor.legs with minecraft:leather_leggings{Unbreakable:1,display:{color:3101912},HideFlags:68} 1
item replace entity @s armor.feet with minecraft:leather_boots{Unbreakable:1,display:{color:14626350},HideFlags:68} 1
...
execute as @s run attribute @s generic.movement_speed base set 0.1175
