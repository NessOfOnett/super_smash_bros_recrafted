...
# King K. Rool
item replace entity @a[tag=kingkrool] armor.head with minecraft:player_head{display:{Name:'{"text":"King K. Rool"}'},SkullOwner:{Id:[I;-639528409,405753123,-1797651965,-89537606],Properties:{textures:[{Value:"eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvYmVmMjc4YmMyMzBmNjU5Yjc1MjUzNjEyMjkwOWE1ZWYzYzExYjM5ZmQyMDY0NGNjZTEyNzc5NDRkNmY3Mjg2NSJ9fX0="}]}}} 1
item replace entity @a[tag=kingkrool] armor.chest with minecraft:golden_chestplate{Unbreakable:1,display:{Name:'[{"text":"King K. Rool Armor","italic":false,"bold":true,"color":"dark_green"}]'},Enchantments:[{id:"projectile_protection",lvl:1}],HideFlags:126} 1
item replace entity @a[tag=kingkrool] armor.legs with minecraft:leather_leggings{Unbreakable:1,display:{color:32283,Name:'[{"text":"King K. Rool Armor","italic":false,"bold":true,"color":"dark_green"}]'},AttributeModifiers:[{AttributeName:"generic.armor",Amount:4,Slot:legs,Name:"generic.armor",UUID:[I;-12164,6969,9489,-13938]}],HideFlags:127} 1
item replace entity @a[tag=kingkrool] armor.feet with minecraft:leather_boots{Unbreakable:1,display:{color:32283,Name:'[{"text":"King K. Rool Armor","italic":false,"bold":true,"color":"dark_green"}]'},AttributeModifiers:[{AttributeName:"generic.armor",Amount:3,Slot:legs,Name:"generic.armor",UUID:[I;-12164,6969,9489,-13938]}],HideFlags:127} 1

item replace entity @a[tag=kingkrool] hotbar.0 with minecraft:red_dye{AttributeModifiers:[{AttributeName:"generic.attack_damage",Amount:7,Slot:mainhand,Name:"generic.attack_damage",UUID:[I;-12164,30107,92130,-60214]},{AttributeName:"generic.attack_speed",Amount:-2.2,Slot:mainhand,Name:"generic.attack_speed",UUID:[I;-12164,30207,92130,-60414]}],display:{Name:'[{"text":"Boxing Glove","italic":false,"color":"red","bold":true}]',Lore:['[{"text":"7 Attack Damage","italic":false,"color":"gray"}]']},HideFlags:127} 1

execute as @a[tag=kingkrool] run attribute @s minecraft:generic.movement_speed base set 0.085
...
item replace entity @a[tag=samus] hotbar.1 with minecraft:carrot_on_a_stick{waveBeam:1,Unbreakable:1,display:{Name:'[{"text":"Wave Beam","italic":false,"color":"light_purple","bold":true}]',Lore:['[{"text":"A Piercing Wave Beam","italic":false}]','[{"text":"*Consumes Arrows","italic":false}]']},Enchantments:[{id:"piercing",lvl:1},{id:"quick_charge",lvl:1}],HideFlags:4} 1
...
scoreboard players set @a[tag=samus] waveBeam 0
# Snake
...
execute as @a[tag=sonic] run attribute @s generic.movement_speed base set 0.1175
