...
item replace entity @a[tag=pit] armor.chest with minecraft:elytra{Damage:417,display:{Name:'[{"text":"Clipped Wings","italic":false,"color":"yellow"}]'},HideFlags:127} 1
