...
item replace entity @a[tag=captainfalcon] bow{Unbreakable:1,display:{Name:'[{"text":"Blaster","italic":false,"color":"gold","bold":true}]'},Enchantments:[{id:"power",lvl:1}],HideFlags:127} 1
