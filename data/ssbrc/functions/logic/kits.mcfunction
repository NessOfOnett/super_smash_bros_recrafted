...
item replace entity @a[tag=donkeykong] hotbar.2 with splash_potion{CustomPotionColor:16744448,display:{Name:'[{"text":"Orange Bomb","italic":false,"bold":true,"color":"gold"}]'},HideFlags:127,CustomPotionEffects:[{Id:7,Duration:0,Amplifier:0,ShowParticles:0,ShowIcon:0}]} 1
item replace entity @a[tag=donkeykong] hotbar.3 with splash_potion{CustomPotionColor:16744448,display:{Name:'[{"text":"Orange Bomb","italic":false,"bold":true,"color":"gold"}]'},HideFlags:127,CustomPotionEffects:[{Id:7,Duration:0,Amplifier:0,ShowParticles:0,ShowIcon:0}]} 1
...
item replace entity @a[tag=link] weapon.offhand with shield{BlockEntityTag:{Base:11,Patterns:[{Pattern:"flo",Color:14},{Pattern:"hh",Color:11},{Pattern:"tt",Color:4},{Pattern:"ts",Color:11},{Pattern:"cbo",Color:8}]}} 1
item replace entity @a[tag=link] hotbar.1 with bow{Unbreakable:1,display:{Name:'[{"text":"Hero\'s Bow","italic":false,"color":"#663300"}]'},Enchantments:[{id:"infinity",lvl:1}],HideFlags:1} 1
item replace entity @a[tag=link] hotbar.8 with arrow 1
...
item replace entity @a[tag=mario] hotbar.8 with arrow 10
...
item replace entity @a[tag=megaman] hotbar.2 with lingering_potion{CustomPotionColor:5974645,display:{Name:'[{"text":"Black Hole Bomb","italic":false,"color":"dark_purple","bold":true}]'},CustomPotionEffects:[{Id:22,Duration:-1},{Id:7,Duration:1,Amplifier:1},{Id:2,Duration:100,Amplifier:6},{Id:20,Duration:160,Amplifier:2}]} 1
item replace entity @a[tag=megaman] hotbar.8 with arrow 1
...
item replace entity @a[tag=ness] hotbar.2 with splash_potion{CustomPotionColor:552489,display:{Name:'[{"text":"PK Flash","italic":false,"bold":true,"color":"green"}]'},CustomPotionEffects:[{Id:15,Duration:160,Amplifier:0},{Id:7,Duration:1,Amplifier:0},{Id:2,Duration:160,Amplifier:1},{Id:18,Duration:160,Amplifier:1}]} 1
...
item replace entity @a[tag=pit] hotbar.8 with arrow 1
...
item replace entity @a[tag=ryu] hotbar.8 with arrow 1
...
item replace entity @a[tag=samus] hotbar.8 with arrow 15
...
item replace entity @a[tag=snake] hotbar.8 with arrow 14
