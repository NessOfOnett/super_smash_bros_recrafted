...
item replace entity @a[tag=bowser] hotbar.0 with minecraft:blaze_rod{AttributeModifiers:[{AttributeName:"generic.attack_damage",Amount:3,Name:"generic.attack_damage",UUID:[I;-121714,15960,124028,-31920]},{AttributeName:"generic.attack_speed",Amount:-2.2,Name:"generic.attack_speed",UUID:[I;-121714,16060,124028,-32120]}],display:{Name:'[{"text":"Star Rod","italic":false,"color":"gold","bold":true}]'},Enchantments:[{id:"fire_aspect",lvl:1}],HideFlags:7} 1
item replace entity @a[tag=bowser] hotbar.1 with minecraft:iron_sword{Unbreakable:1,AttributeModifiers:[{AttributeName:"generic.attack_damage",Amount:7,Slot:mainhand,Name:"generic.attack_damage",UUID:[I;-121512,25020,123840,-50040]},{AttributeName:"generic.attack_speed",Amount:-3,Slot:mainhand,Name:"generic.attack_speed",UUID:[I;-121512,25120,123840,-50240]}],display:{Name:'[{"text":"Koopa Klaw","italic":false,"color":"red","bold":true}]',Lore:['[{"text":"7 Attack Damage","italic":false,"color":"blue"}]','[{"text":"-3 Attack Speed","italic":false,"color":"blue"}]']},Enchantments:[{}],HideFlags:127} 1
...
item replace entity @a[tag=donkeykong] hotbar.2 with minecraft:splash_potion{CustomPotionColor:16744448,display:{Name:'[{"text":"Orange Bomb","italic":false,"bold":true,"color":"gold"}]'},HideFlags:127,CustomPotionEffects:[{Id:7,Duration:0,Amplifier:0,ShowParticles:0,ShowIcon:0}]} 1
item replace entity @a[tag=donkeykong] hotbar.3 with minecraft:splash_potion{CustomPotionColor:16744448,display:{Name:'[{"text":"Orange Bomb","italic":false,"bold":true,"color":"gold"}]'},HideFlags:127,CustomPotionEffects:[{Id:7,Duration:0,Amplifier:0,ShowParticles:0,ShowIcon:0}]} 1
...
item replace entity @a[tag=fox] hotbar.8 with minecraft:arrow 10
...
item replace entity @a[tag=greninja] armor.feet with minecraft:leather_boots{Unbreakable:1,display:{color:3491733,Name:'[{"text":"Greninja Armor","italic":false,"color":"blue","bold":true}]'},HideFlags:127} 1
...
item replace entity @a[tag=hero] hotbar.1 with minecraft:bow{Unbreakable:1,display:{Name:'[{"text":"Frizzle","italic":false,"color":"yellow","bold":true}]'},Enchantments:[{id:"flame",lvl:1},{id:"infinity",lvl:1}],HideFlags:126} 1
item replace entity @a[tag=hero] hotbar.8 with minecraft:arrow 1
...
item replace entity @a[tag=joker] hotbar.2 with minecraft:lingering_potion{CustomPotionColor:1470985,display:{Name:'[{"text":"Eiagon","italic":false,"color":"gold","bold":true}]'},HideFlags:127,CustomPotionEffects:[{Id:7,Duration:1,Amplifier:0,ShowParticles:0,ShowIcon:0},{Id:9,Duration:160,Amplifier:0,ShowParticles:0,ShowIcon:0},{Id:20,Duration:320,Amplifier:0,ShowParticles:0,ShowIcon:0}]} 1
...
item replace entity @a[tag=link] hotbar.0 with minecraft:iron_sword{Unbreakable:1,AttributeModifiers:[{AttributeName:"generic.attack_damage",Amount:7,Slot:mainhand,Name:"generic.attack_damage",UUID:[I;-12164,54007,92130,-108014]}],display:{Name:'[{"text":"Master Sword","italic":false,"color":"blue","bold":true}]',Lore:['[{"text":"7 Attack Damage","italic":false,"color":"gray"}]','[{"text":"Sweeping Edge II","italic":false,"color":"gray"}]']},Enchantments:[{id:"sweeping",lvl:2}],HideFlags:127} 1
item replace entity @a[tag=link] weapon.offhand with minecraft:shield{BlockEntityTag:{Base:11,Patterns:[{Pattern:"flo",Color:14},{Pattern:"hh",Color:11},{Pattern:"tt",Color:4},{Pattern:"ts",Color:11},{Pattern:"cbo",Color:8}]}} 1
...
item replace entity @a[tag=ness] hotbar.0 with minecraft:wooden_shovel{Unbreakable:1,AttributeModifiers:[{AttributeName:"generic.attack_damage",Amount:6,Name:"generic.attack_damage",UUID:[I;-121615,36431,13025,-72862]},{AttributeName:"generic.attack_speed",Amount:-1.6,Name:"generic.attack_speed",UUID:[I;-121615,36531,13025,-73062]}],display:{Name:'[{"text":"Cracked Bat","italic":false,"color":"#666633","bold":true}]'},HideFlags:28,CanDestroy:[wet_sponge]} 1
item replace entity @a[tag=ness] hotbar.1 with minecraft:blaze_powder{AttributeModifiers:[{AttributeName:"generic.attack_damage",Amount:5,Name:"generic.attack_damage",UUID:[I;-121615,37231,13025,-74462]},{AttributeName:"generic.attack_speed",Amount:-1.8,Name:"generic.attack_speed",UUID:[I;-121615,37331,13025,-74662]}],display:{Name:'[{"text":"PK Fire α","italic":false,"color":"#cc0033","bold":true}]'},Enchantments:[{id:"fire_aspect",lvl:1}],HideFlags:1} 1
item replace entity @a[tag=ness] hotbar.2 with minecraft:splash_potion{CustomPotionColor:552489,display:{Name:'[{"text":"PK Flash","italic":false,"bold":true,"color":"green"}]'},CustomPotionEffects:[{Id:15,Duration:160,Amplifier:0},{Id:7,Duration:1,Amplifier:0},{Id:2,Duration:160,Amplifier:1},{Id:18,Duration:160,Amplifier:1}]} 1
...
item replace entity @a[tag=pit] armor.chest with minecraft:elytra{Unbreakable:1,HideFlags:4} 1
...
item replace entity @a[tag=ryu] hotbar.0 with minecraft:iron_sword{Unbreakable:1,AttributeModifiers:[{AttributeName:"generic.attack_damage",Amount:5,Name:"generic.attack_damage",UUID:[I;-121615,30461,16469,-60922]},{AttributeName:"generic.attack_speed",Amount:-1.8,Name:"generic.attack_speed",UUID:[I;-121615,30561,16469,-61122]}],display:{Name:'[{"text":"Collarbone Breaker","italic":false,"color":"#777777","bold":true}]'},HideFlags:6} 1
...
item replace entity @a[tag=snake] hotbar.0 with minecraft:iron_sword{Unbreakable:1,AttributeModifiers:[{AttributeName:"generic.attack_damage",Amount:6,Name:"generic.attack_damage",UUID:[I;-121615,34731,13025,-69462]},{AttributeName:"generic.attack_speed",Amount:-3.1,Name:"generic.attack_speed",UUID:[I;-121615,34831,13025,-69662]}],display:{Name:'[{"text":"CQC Knife","italic":false,"color":"green","bold":true}]'},HideFlags:4} 1
