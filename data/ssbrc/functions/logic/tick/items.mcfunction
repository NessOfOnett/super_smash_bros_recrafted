...
execute as @a[tag=hero,scores={useAbility=1..,mana=1..},nbt={SelectedItem:{tag:{heroAbility:1}}}] at @s run function ssbrc:characters/hero/flame_slash
execute as @a[tag=hero,scores={useAbility=1..,mana=2..},nbt={SelectedItem:{tag:{heroAbility:2}}}] at @s run function ssbrc:characters/hero/bang
execute as @a[tag=hero,scores={useAbility=1..,mana=3..},nbt={SelectedItem:{tag:{heroAbility:3}}}] run function ssbrc:characters/hero/kaclang
execute as @a[tag=hero,scores={useAbility=1..,mana=21..},nbt={SelectedItem:{tag:{heroAbility:4}}}] run function ssbrc:characters/hero/magic_burst_activate
...
execute as @a[tag=snake,tag=snake.psg1,tag=!snake.psg1R,scores={useAbility=1..},nbt={SelectedItem:{tag:{PSG1:1}}}] at @s run function ssbrc:characters/snake/psg-1
