...
item replace entity @s weapon.offhand with minecraft:shield{Damage:300,display:{Name:'[{"text":"Hero Shield","italic":false,"color":"white","bold":true}]'},HideFlags:127} 1
