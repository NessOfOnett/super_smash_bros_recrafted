...
item replace entity @s weapon.offhand with minecraft:shield{Damage:300,BlockEntityTag:{Base:11,Patterns:[{Color:4,Pattern:"flo"},{Color:4,Pattern:"sku"},{Color:14,Pattern:"mc"},{Color:4,Pattern:"bo"}]},display:{Name:'[{"text":"Hero Shield","italic":false,"color":"white","bold":true}]'},HideFlags:127} 1
