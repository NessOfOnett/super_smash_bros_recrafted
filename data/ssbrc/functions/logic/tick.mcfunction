...
# Specific characters
execute if score $start map matches 1 run function ssbrc:characters/hero/tick
execute if score $start map matches 1 run function ssbrc:characters/snake/tick
