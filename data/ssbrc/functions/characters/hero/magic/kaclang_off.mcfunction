...
item replace entity @a[tag=hero,tag=kaclangUsed,scores={mana=2..}] hotbar.1 with minecraft:carrot_on_a_stick{heroAbility:2,Unbreakable:1,display:{Name:'[{"text":"Bang","italic":false,"color":"yellow","bold":true}]'},HideFlags:127} 1
item replace entity @a[tag=hero,tag=kaclangUsed,scores={mana=3..}] hotbar.2 with minecraft:carrot_on_a_stick{heroAbility:3,Unbreakable:1,display:{Name:'[{"text":"Kaclang","italic":false,"color":"gray","bold":true}]'},HideFlags:127} 1
