...
execute positioned ^-0.50 ^ ^-0.2 run scoreboard players set @a[tag=!self,scores={swordBeam=..30}] swordBeam 50
execute positioned ^-0.25 ^ ^-0.1 run scoreboard players set @a[tag=!self,scores={swordBeam=..30}] swordBeam 50
execute positioned ^ ^ ^ run scoreboard players set @a[tag=!self,scores={swordBeam=..30}] swordBeam 50
execute positioned ^0.25 ^ ^-0.1 run scoreboard players set @a[tag=!self,scores={swordBeam=..30}] swordBeam 50
execute positioned ^0.50 ^ ^-0.2 run scoreboard players set @a[tag=!self,scores={swordBeam=..30}] swordBeam 50
