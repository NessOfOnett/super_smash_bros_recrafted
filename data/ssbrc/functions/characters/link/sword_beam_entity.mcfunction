...
execute positioned ^-0.50 ^ ^-0.2 run effect give @a[tag=!self,distance=..0.15] minecraft:instant_damage 1 0 true
execute positioned ^-0.25 ^ ^-0.1 run effect give @a[tag=!self,distance=..0.15] minecraft:instant_damage 1 0 true
execute positioned ^ ^ ^ run effect give @a[tag=!self,distance=..0.15] minecraft:instant_damage 1 0 true
execute positioned ^0.25 ^ ^-0.1 run effect give @a[tag=!self,distance=..0.15] minecraft:instant_damage 1 0 true
execute positioned ^0.50 ^ ^-0.2 run effect give @a[tag=!self,distance=..0.15] minecraft:instant_damage 1 0 true
