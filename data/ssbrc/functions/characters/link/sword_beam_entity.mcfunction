...
execute positioned ^-0.50 ^ ^-0.2 run effect give @a[dx=0.15,dy=0.15,dz=0.15] minecraft:instant_damage 1 0 true
execute positioned ^-0.25 ^ ^-0.1 run effect give @a[dx=0.15,dy=0.15,dz=0.15] minecraft:instant_damage 1 0 true
execute positioned ^ ^ ^ run effect give @a[dx=0.15,dy=0.15,dz=0.15] minecraft:instant_damage 1 0 true
execute positioned ^0.25 ^ ^-0.1 run effect give @a[dx=0.15,dy=0.15,dz=0.15] minecraft:instant_damage 1 0 true
execute positioned ^0.50 ^ ^-0.2 run effect give @a[dx=0.15,dy=0.15,dz=0.15] minecraft:instant_damage 1 0 true
