...
execute if score @s[predicate=ssbrc:awakened] swordSpin matches 121..140 at @s rotated as @e[tag=spinner,limit=1] run particle minecraft:dust 1.0 0.0 0.0 1.0 ^ ^ ^2.25 0.0 0.0 0.0 0 1 normal @a
execute if score @s[predicate=ssbrc:awakened] swordSpin matches 141.. at @s rotated as @e[tag=spinner,limit=1] run particle minecraft:dust 0.25 0.0 0.0 1.0 ^ ^ ^2.5 0.0 0.0 0.0 0 1 normal @a
